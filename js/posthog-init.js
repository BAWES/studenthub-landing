/**
 * PostHog Initialization — StudentHub
 * Loads the PostHog SDK and initialises with project token.
 * This file is included in <head> on every page.
 */
...
posthog.init('phc_sN2BiBuMpLRVZeyLiYh2xFcJa6rrw2er6axFCFgBLCmw', {
